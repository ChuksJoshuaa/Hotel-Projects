...
const HotelBrand_entity_1 = require("./HotelBrand.entity");
...
__decorate([
    (0, type_graphql_1.Field)(() => HotelBrand_entity_1.HotelBrand),
    (0, typeorm_1.ManyToOne)(() => HotelBrand_entity_1.HotelBrand, (item) => item.brands, {
        onUpdate: "CASCADE",
        onDelete: "CASCADE",
    }),
    (0, typeorm_1.JoinColumn)({ name: "brand" }),
    __metadata("design:type", HotelBrand_entity_1.HotelBrand)
